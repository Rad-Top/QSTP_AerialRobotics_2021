...
class GridWorld:
    ...
    def make_obstacles(self):
        '''Make obstacles and append them to the obstacles list.'''
        ...
        for i in range(0, int(self.obstacle_level * self.X * self.Y)):
            ...
            if obst_type == "boxes":
                ...
                self.obstacles.append(
                    Obstacle(
                        Polygon( # Makes an obstacle of the obove dimensions
                            [
                                (x, y),
                                (x, y + height),
                                (x + width, y + height),
                        ...
                        "box",# Obstacle of type box
                    )
                )
            else:
                self.obstacles.append(
                    Obstacle(Point(x, y).buffer(np.random.uniform(0.5, 1.5)), "circle") # Makes obstacles of type circle  
                )
